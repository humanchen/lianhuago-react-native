    ...
    return (
      <Swiper style={styles.wrapper}
       ...
       <View style={styles.slide1}>
         ...
         <Image  source={{url:this.state.img1}} style={styles.tabIcon}/>
       </View>
       <View style={styles.slide2}>
         {/* <Text style={styles.text}>Beautiful</Text> */}
         <Image  source={{url:this.state.img2}} style={styles.tabIcon}/>
       </View>
       <View style={styles.slide3}>
         {/* <Text style={styles.text}>And simple</Text> */}
         <Image  source={{url:this.state.img3}} style={styles.tabIcon}/>
       </View>
     </Swiper>
    );
  }
